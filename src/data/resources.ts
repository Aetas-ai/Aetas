...
export const resources: ResourceArticle[] = [
  {
    ...
    body: [
      ...
      'AGI uses Human Led AI with Expert Human Oversight of AI (Expert in the Loop). The goal is to help operators classify requests, draft responses, and surface relevant knowledge while keeping the final decision with a trained specialist.',
  ...
  },
  {
    ...
    body: [
      ...
      'AGI cybersecurity specialists support detection, investigation, response, documentation, and escalation through the MXDR service.',
  ...
  },
  {
    ...
    body: [
      ...
      'AGI managed IT specialists structure recurring IT work into queues with clear owners, repeatable checklists, and escalation criteria.',
